# Tera — Legacy Smart Contract Documentation (Archived)
...
> Tera has been fully migrated to **Soroban smart contracts** on the **Stellar network**.
> See [`tera/soroban/`](../tera/soroban/) for the current architecture.
