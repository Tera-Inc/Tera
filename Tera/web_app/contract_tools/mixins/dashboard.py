"""
This module contains the dashboard mixin class for the Stellar-based Tera protocol.
...
class DashboardMixin:
    ...
    async def get_current_prices(cls) -> Dict[str, Decimal]:
        ...
        internal token symbols used throughout Tera.
