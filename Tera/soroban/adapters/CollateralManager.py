"""
tera/soroban/adapters/CollateralManager.py

Tera Collateral Manager

Provides the collateral management abstraction layer for the Tera protocol.
...
``tera.web_app.contract_tools.constants`` which reads from the environment,
...
class CollateralManager:
    """
    Manages collateral operations for Tera positions.
