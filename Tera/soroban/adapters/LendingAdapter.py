...
The adapter pattern allows Tera to support multiple Stellar-native lending
...
class LendingAdapter(ABC):
    ...
    this interface to ensure compatibility with Tera's leverage engine.
    """
...
class LendingAdapterFactory:
    ...
    Allows Tera to dynamically select which lending protocol
