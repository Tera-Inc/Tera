# Tera Soroban Smart Contracts

This directory contains the **Soroban smart contract** abstractions for the Tera protocol on the Stellar network.

## Architecture

Tera uses abstraction layers to interface with Stellar ecosystem components:
