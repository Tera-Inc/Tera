"""
Tests for tera.soroban.adapters.soroswap_adapter.
...
from tera.soroban.adapters import AMMAdapterFactory, SoroswapAMMAdapter
from tera.soroban.adapters.AMMAdapter import PoolKey
from tera.soroban.adapters.soroswap_adapter import _TokenResolver
