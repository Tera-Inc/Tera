...
import TeraApp from '@/pages/tera-app/TeraApp';
...
import WithdrawAll from '@/pages/tera/dashboard/withdraw-all/WithdrawAll';
import { DefiSpringPage } from '@/pages/tera/defi-spring/DefiSpring';
...
function App() {
  ...
  return (
    <div className={`${location.pathname === '/' ? 'home' : isNarrowSidebar ? 'App narrow-sidebar' : 'App'}`}>
      ...
      <main>
        <Routes>
          <Route index element={<TeraApp onConnectWallet={handleConnectWallet} onLogout={handleLogout} />} />
