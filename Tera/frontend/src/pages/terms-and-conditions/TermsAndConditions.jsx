      ...
      content: [
        {
          type: 'text',
          value:
            'Using the Tera protocol involves certain risks. Please review and understand these risks before interacting with the platform.',
        },
        {
          type: 'orderedList',
          items: [
            ...
            'Third-Party Integrations. The protocol may integrate with third-party protocols, dApps, or platforms. These third-party services come with their own risks, and Tera is not responsible for issues arising from third-party integrations, including security vulnerabilities or loss of funds.',
