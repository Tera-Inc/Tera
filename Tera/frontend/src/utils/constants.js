/**
 * Tera Stellar Network Constants
 *
 * Contains Stellar asset addresses, network configuration, and
 * Soroban contract parameters for the Tera protocol.
 *
...
// Tera Soroban Contract Configuration
export const CONTRACT_ADDRESS =
  process.env.VITE_TERA_CONTRACT_ID ||
  'CCJZ5LW4CJ3J3Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5'; // Placeholder

export const SOROBAN_WASM_HASH =
  process.env.VITE_TERA_WASM_HASH || '';

// Time constants
export const ONE_HOUR_IN_MILLISECONDS = 3600000;

// Telegram bot link
export const TELEGRAM_BOT_LINK = 'https://t.me/tera_bot';
...
// Stellar-supported tokens for the Tera protocol
